    ...
    <div className='container app'>
       ...
       { data && 
            <div className='row border'>
                <div className='cols border text-center yColor'><h1>Movie Details</h1></div>
                ...
                <button className='btn '><Link className = 'yColor' to={'/bookmyticket/'+data.title}>Book Now</Link></button>
                </div>
        }
